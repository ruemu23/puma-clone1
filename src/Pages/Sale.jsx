...
const Sale = () => {
  ...
  return (
    ...
    <div className='women1'>
        ...
        <p className='hider painter'>Home</p> <p className="hider fanta"><FontAwesomeIcon icon={faCircle} className="iconic" /></p> <p className="mission fanta"><FaChevronLeft /></p> <p className='painter'>Sale</p> <p className="hider fanta"><FontAwesomeIcon icon={faCircle} className="iconic" /></p> <p className="hider">All Sale</p>
      </div>
  
      <div className='shopall'><h1 className="shopmez">SHOP ALL SALE</h1></div>
  
      <Filter />
  
      <div className='prodlist'>
         <div className='prodtext'>244 PRODUCTS</div>
         <div className='prod1'>
